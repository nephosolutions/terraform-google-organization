...
| <a name="module_bootstrap_project"></a> [bootstrap\_project](#module\_bootstrap\_project) | nephosolutions/gcp-project/google | ~> 7.1.0 |
...
| [google_organization_iam_binding.basic_role](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/organization_iam_binding) | resource |
...
| <a name="input_editors"></a> [editors](#input\_editors) | Identities that will be granted the basic role `editor` on the organization | `list(string)` | `[]` | no |
...
| <a name="input_owners"></a> [owners](#input\_owners) | Identities that will be granted the basic role `owner` on the organization | `list(string)` | `[]` | no |
| <a name="input_viewers"></a> [viewers](#input\_viewers) | Identities that will be granted the basic role `viewer` on the organization | `list(string)` | `[]` | no |
